...
class zentao_cli(object):
    ...
    def create_new_task(self):
        ...
        taskDict = {
            ...
            21: [['大促值守监控巡检', '6', '大促前大表降水位'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            22: [['大促值守监控巡检', '6', '大促前大表降水位'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            23: [['大促值守监控巡检', '6', '大促前大表降水位'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            24: [['大促值守监控巡检', '6', '大促前大表降水位'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            25: [['大促值守监控巡检', '6', '大促前大表降水位'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            26: [['大促值守监控巡检', '6', '大促前大表降水位'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            27: [['大促值守监控巡检', '6', '大促前大表降水位'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            28: [['大促值守监控巡检', '6', '大促前大表降水位'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            29: [['大促值守监控巡检', '6', '大促前大表降水位'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            30: [['大促值守监控巡检', '6', '大促前大表降水位'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            31: [['大促值守监控巡检', '6', '大促前大表降水位'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],
        }
