...
class zentao_cli(object):
    ...
    def create_new_task(self):
        ...
        taskDict = {
            ...
            11: [['大促前大表降水位', '6', '大促前大表降水位'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            12: [['大促前大表降水位', '6', '大促前大表降水位'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            13: [['大促前大表降水位', '6', '大促前大表降水位'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            14: [['大促前大表降水位', '6', '大促前大表降水位'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            15: [['大促前大表降水位', '6', '大促前大表降水位'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],
            ...
            22: [['SAP和微软正版化流程', '4', 'SAP合同签署，微软付款打回再次提交'],
                 ['准备压测数据库环境', '4',
                  '准备压测数据库环境']],

            23: [['大促前大表降水位', '4', '大促前大表降水位'],
                 ['SAP和微软正版化流程', '4', 'SAP合同签署，微软付款打回再次提交']],
