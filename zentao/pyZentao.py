...
class zentao_cli(object):
    ...
    def create_new_task(self):
        ...
        taskDict = {
            ...
            21: [['归档MySQL数据向黄岛大数据平台迁移', '6', '归档MySQL数据向黄岛大数据平台迁移'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            22: [['归档MySQL数据向黄岛大数据平台迁移', '6', '归档MySQL数据向黄岛大数据平台迁移'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            23: [['归档MySQL数据向黄岛大数据平台迁移', '6', '归档MySQL数据向黄岛大数据平台迁移'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            24: [['归档MySQL数据向黄岛大数据平台迁移', '6', '归档MySQL数据向黄岛大数据平台迁移'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            25: [['归档MySQL数据向黄岛大数据平台迁移', '6', '归档MySQL数据向黄岛大数据平台迁移'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            26: [['归档MySQL数据向黄岛大数据平台迁移', '6', '归档MySQL数据向黄岛大数据平台迁移'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            27: [['归档MySQL数据向黄岛大数据平台迁移', '6', '归档MySQL数据向黄岛大数据平台迁移'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            28: [['归档MySQL数据向黄岛大数据平台迁移', '6', '归档MySQL数据向黄岛大数据平台迁移'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            29: [['归档MySQL数据向黄岛大数据平台迁移', '6', '归档MySQL数据向黄岛大数据平台迁移'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            30: [['归档MySQL数据向黄岛大数据平台迁移', '6', '归档MySQL数据向黄岛大数据平台迁移'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],

            31: [['归档MySQL数据向黄岛大数据平台迁移', '6', '归档MySQL数据向黄岛大数据平台迁移'],
                 ['处理数据变更、导出，数据库和例外软件权限审批', '2',
                  '处理数据变更、导出，数据库和例外软件权限审批']],
        }
